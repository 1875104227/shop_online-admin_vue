    ...
    <div :style="'width: calc(100% - ' + dialogProps.labelWidth! / 2 + 'px)'">
      ...
      >
        ...
        <el-form-item label="手机号" prop="mobile">
          <el-input v-model="dialogProps.row!.mobile" placeholder="" clearable :disabled="dialogProps.title == '充值'"></el-input>
        </el-form-item>
        ...
        <el-form-item label="生日" prop="birthday">
          <el-input v-model="dialogProps.row!.birthday" placeholder="" clearable :disabled="dialogProps.title == '充值'"></el-input>
        </el-form-item>
